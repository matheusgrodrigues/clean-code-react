...
export const CodigoBom: React.FC = () => {
  ...
  return (
    <ul>
      ...
      <li>
        Obs: utilizei o tipo {"string[]"} na variavel skills, porém, o typescript ofereçe suporte a inferência de tipos, por
        tanto, neste caso prefira não adicionar o tipo, deixe que o typescript infira o tipo automaticamente.
      </li>
    </ul>
  );
};
